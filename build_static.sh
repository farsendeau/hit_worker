...
# Copier l'exécutable
cp build_static/bin/Moteur2d "$DIST_DIR/"

# Vérifier que c'est bien statique
echo ""
echo "=== Vérification des dépendances ==="
ldd "$DIST_DIR/Moteur2d" | grep -i allegro || echo "✓ Aucune dépendance Allegro dynamique (bon signe!)"

echo ""
echo "=== Dépendances système restantes ==="
ldd "$DIST_DIR/Moteur2d"
...
echo "========================================="
echo ""
echo "Exécutable standalone créé dans: $DIST_DIR/Moteur2d"
echo ""
...
echo ""
echo "Pour tester, copiez juste le fichier Moteur2d sur un autre PC"
echo "et exécutez-le directement: ./Moteur2d"
echo ""
